...
export default function GasSlider({setGas}): JSX.Element {
  ...
  sliderSteps.forEach(function (step) {
    sliderMarks[step[0]] = { style: { color: 'rgba(67, 56, 202)' }, label: step[1] };
  });
    ...
    <p className="text-xs pt-4">Transaction Speed</p>
        <div className="w-full ml-1 pb-3">
          <Slider
            ...
            dotStyle={{ backgroundColor: 'rgba(67, 56, 202)', border: 'rgba(67, 56, 202)' }}
            activeDotStyle={{ backgroundColor: 'rgba(67, 56, 202)', border: 'rgba(67, 56, 202)' }}
