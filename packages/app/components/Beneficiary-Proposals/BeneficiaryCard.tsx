    ...
    <li
      ...
      onClick={() =>
        (window.location.href =
          'beneficiary-proposals/' + beneficiary.ethereumAddress)
      }
    >
      <div className="space-y-4 border-2 rounded-lg p-2 bg-white">
        ...
        <div className="space-y-2">
          <div className="text-lg leading-6 font-medium space-y-1">
            ...
            <p className="mb-3 text-3xl font-bold text-gray-600">
              {beneficiary.currentStage}
            </p>
            <p className="mb-3 text-xl font-bold text-gray-600">
              {beneficiary.stageDeadline.toString()}
            </p>
            <p className="mb-3 text-xl font-bold text-gray-600">
              {beneficiary.votes + ' votes cast'}
            </p>
