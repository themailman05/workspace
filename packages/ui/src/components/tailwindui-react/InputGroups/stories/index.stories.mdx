...
<Meta title="Tailwind UI / InputGroups" />
...
<Story name="InputWithInsetLabel">
    <InputWithInsetLabel />
</Story>

<Story name="InputsWithInsetLabelsAndSharedBorders">
    <InputsWithInsetLabelsAndSharedBorders />
</Story>

<Story name="InputWithOverlappingLabel">
    <InputWithOverlappingLabel />
</Story>

<Story name="InputWithPillShape">
    <InputWithPillShape />
</Story>

<Story name="InputWithGrayBackgroundAndBottomBorder">
    <InputWithGrayBackgroundAndBottomBorder />
</Story>

<Story name="InputWithKeyboardShortcut">
